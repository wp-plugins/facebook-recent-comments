...
function frc_no_curl_notice() {
	?>
	<div class="error">
		<p><strong>Facebook Recent Comments Disabled:</strong> Curl extension is not found on this server. The Curl extension is a requirement to call the Facebook API.</strong></p>
	</div>
	<?php
}
